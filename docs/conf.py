# -*- coding: utf-8 -*-
#
# yadll documentation build configuration file, created by
...
project = u'yadll'
copyright = u'2016, Philippe Chavanne'
author = u'Philippe Chavanne'
...
version = '0.0'  # '.'.join(yadll.__version__.split('.', 2)[:2])
# The full version, including alpha/beta/rc tags.
release = '0.0.1'  # yadll.__version__
...
latex_documents = [
    (master_doc, 'yadll.tex', u'yadll Documentation',
     u'Philippe Chavanne', 'manual'),
]
...
man_pages = [
    (master_doc, 'yadll', u'yadll Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'yadll', u'yadll Documentation',
     author, 'yadll', 'One line description of project.',
     'Miscellaneous'),
]
